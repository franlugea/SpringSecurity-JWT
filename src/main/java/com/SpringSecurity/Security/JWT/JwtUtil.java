...
public class JwtUtil {
    ...
    public String createToken(Authentication authentication){
        return this.generateToken(authentication,180000);
    }

    public String createRefreshToken(Authentication authentication){
        return this.generateToken(authentication,60*60*10000);
    }
    ...
    public DecodedJWT validateToken(String token){
        try{
            ...
            throw new JWTVerificationException("El token ha expirado, por favor renueve su sesión.");

        } catch (SignatureVerificationException e) {
            throw new JWTVerificationException("Token inválido, la firma no coincide.");
